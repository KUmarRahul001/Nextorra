...
const ServicesOverview: React.FC = () => {
  const services: Service[] = [
    ...
    },
    {
      ...
      description: 'Convert prospects into qualified leads with targeted campaigns and optimization strategies.',
      icon: <Target className="w-8 h-8" />,
      path: '/services/lead-generation',
      features: ['Landing Pages', 'Lead Magnets', 'Conversion Optimization', 'Lead Nurturing']
    },
    {
      title: 'SMS Marketing',
      description: 'Reach customers directly with personalized SMS campaigns that drive engagement and sales.',
      icon: <MessageSquare className="w-8 h-8" />,
      path: '/services/sms-marketing',
      features: ['Bulk SMS', 'Automated Campaigns', 'Two-way Messaging', 'Analytics']
    },
    {
    ...
    },
    {
      ...
      features: ['Custom Development', 'Database Design', 'API Integration', 'Cloud Deployment']
    },
    {
      title: 'Email Marketing',
      description: 'Engage your audience with personalized email campaigns that convert and retain customers.',
    ...
    },
    {
      ...
      description: 'Never miss a customer inquiry with automated missed call services and follow-ups.',
      icon: <Phone className="w-8 h-8" />,
      path: '/services/missed-call-service',
      features: ['Auto Response', 'Lead Capture', 'Real-time Alerts', 'Integration Ready']
    },
    {
      title: 'Graphic Design',
      description: 'Professional designs that communicate your brand message and stand out from the competition.',
    ...
    },
    {
      ...
      description: 'Automated voice calling solutions for marketing, surveys, and customer engagement.',
      icon: <PhoneCall className="w-8 h-8" />,
      path: '/services/voice-call-services',
      features: ['IVR Systems', 'Bulk Voice Calls', 'Call Analytics', 'Custom Messages']
    },
    {
