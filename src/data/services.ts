...
export const tier1Services: Service[] = [
  {
    ...
    featured: true,
    available: true,
    delivery: '3–7 Business Days (Express 24h available)',
    ...
    pricing: {
      ...
      packages: [
        ...
        },
        {
          ...
          delivery: '7–12 Days',
          features: [
            'Up to 10 Pages + Dynamic Blog Engine',
      ...
      fastPrice: '₹14,999 (3 Days)',
      expressPrice: '₹17,999 (24–48 Hours)',
      emergencyPrice: '₹7,499 (24h Single-Page Launch)',
  ...
  },
  {
    ...
    warranty: '60-day post-launch technical warranty',
  ...
  },
  {
    ...
    pricing: {
      ...
      currency: 'INR',
      startingAt: '₹44,999',
      startingAmount: 44999,
      recommendedPrice: '₹79,999',
      packages: [
        {
  ...
  },
  {
    ...
    warranty: '30-day technical warranty',
    ...
    pricing: {
      ...
      fastPrice: '₹7,499 (48 Hours)',
      expressPrice: '₹8,999 (24 Hours)',
      emergencyPrice: '₹2,999 (Emergency Webhook / Payment Fix)',
  ...
  },
  {
    ...
    featured: true,
    available: true,
    delivery: '4–8 Weeks (Modular Phased Rollout)',
    ...
    warranty: '90-day post-launch technical warranty',
    ...
    pricing: {
      ...
      packages: [
        ...
        },
        {
          ...
          features: [
            ...
            'Dedicated Lead Architect & On-Site Deployment Support',
      ...
      monthlyRetainer: '₹8,999/mo (Command Retainer)',
      gstNote: 'All prices exclude 18% GST where applicable.',
  ...
  },
  {
    ...
    pricing: {
      ...
      currency: 'INR',
      startingAt: '₹64,999',
      startingAmount: 64999,
      recommendedPrice: '₹1,24,999',
      packages: [
        {
      ...
      expressPrice: 'Custom Scoping',
      emergencyPrice: 'N/A',
      monthlyRetainer: '₹6,999/mo (SaaS Infra Care)',
      gstNote: 'All prices exclude 18% GST where applicable.',
  ...
  },
  {
    ...
    warranty: '45-day technical warranty',
...
export const tier2Services: Service[] = [
  {
    ...
    warranty: '30-day technical support warranty',
    ...
    pricing: {
      ...
      fastPrice: '₹3,499 (24 Hours)',
      expressPrice: '₹4,499 (Same Day)',
      emergencyPrice: '₹1,999 (GBP Suspension / Appeal Assist)',
  ...
  },
  {
    ...
    featured: false,
    available: true,
    delivery: '3–5 Business Days (or Monthly Retainer)',
    ...
    warranty: 'Asset delivery guarantee with full commercial ownership',
    ...
    pricing: {
      ...
      fastPrice: '₹3,499 (Creative Pack in 24h)',
      expressPrice: '₹4,999 (Urgent Campaign Pack)',
  ...
  },
  {
    ...
    warranty: 'Full commercial copyright handover',
    ...
    pricing: {
      ...
      fastPrice: '₹3,499 (Logo in 24h)',
      expressPrice: '₹5,499 (Complete Kit in 24h)',
      emergencyPrice: '₹2,499 (Urgent Banner / Flyer in 6h)',
  ...
  },
  {
    ...
    pricing: {
      ...
      fastPrice: '₹2,999 (Deliverability in 6h)',
      expressPrice: '₹4,999 (Full Setup in 24h)',
      emergencyPrice: '₹1,999 (Emergency Spam Trap Fix)',
  ...
  },
  {
    ...
    pricing: {
      ...
      fastPrice: '₹2,999 (24 Hours)',
      expressPrice: '₹4,499 (Same Day)',
      emergencyPrice: '₹1,999 (API Gateway Fix)',
  ...
  },
  {
    ...
    pricing: {
      ...
      fastPrice: '₹3,499 (24 Hours)',
      expressPrice: '₹5,499 (Same Day)',
      emergencyPrice: '₹1,999 (Telephony Webhook Fix)',
  ...
  },
  {
    ...
    pricing: {
      ...
      fastPrice: '₹4,999 (24 Hours)',
      expressPrice: '₹7,999 (Urgent Campaign)',
      emergencyPrice: '₹2,499 (IVR Forwarding / Line Fix)',
