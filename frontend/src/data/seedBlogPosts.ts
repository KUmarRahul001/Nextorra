...
export const SEED_BLOG_POSTS: BlogPostItem[] = [
  {
    id: 'post-cybersecurity-threats-2026',
    title: 'Top Emerging Cybersecurity Threats & How Enterprise Networks Prevent Breaches in 2026',
    slug: 'top-emerging-cybersecurity-threats-enterprise-breach-prevention',
    category: 'Cybersecurity & Threats',
    excerpt: 'A comprehensive investigation into zero-day exploits, ransomware attack vectors, supply-chain vulnerabilities, and multi-layered zero-trust defenses for enterprise cloud architectures.',
    featured_image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1200&auto=format&fit=crop&q=80',
    tags: ['Cybersecurity', 'Hacking Defense', 'Zero Trust', 'Cloud Security', 'DevSecOps'],
    author: 'Rahnoxa Security & Architecture Team',
    reading_time: '7 min read',
    status: 'PUBLISHED',
    is_ai_generated: 1,
    ai_seo_score: 98,
    seo_title: 'Top Emerging Cybersecurity Threats & Enterprise Breach Prevention | Rahnoxa',
    seo_description: 'Discover how modern enterprises defend against zero-day exploits, ransomware, and supply chain attacks using zero-trust architecture.',
    canonical_url: 'https://rahnoxa.rahnoxa-tech.workers.dev/blog/top-emerging-cybersecurity-threats-enterprise-breach-prevention',
    published_at: new Date(Date.now() - 86400000 * 2).toISOString(),
    created_at: new Date(Date.now() - 86400000 * 2).toISOString(),
    content: `## Executive Overview: The Modern Cybersecurity Threat Landscape
...
- [Schedule a Technical Security Consultation](/get-started)`,
  },
  {
    id: 'post-deepfake-fraud-prevention',
    title: 'AI Deepfake Fraud & Modern Social Engineering Scams: Detection & Defense Protocols',
    slug: 'ai-deepfake-fraud-social-engineering-scams-detection-defense',
    category: 'Fraud & Scam Prevention',
    excerpt: 'Exploring the rise of synthetic voice cloning, video deepfakes, CEO wire fraud, and multi-factor biometric verification protocols required to protect corporate assets.',
    featured_image: 'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=1200&auto=format&fit=crop&q=80',
    tags: ['Fraud Prevention', 'Scams', 'AI Deepfakes', 'Fintech Security', 'Cybercrime'],
    author: 'Rahnoxa AI & Fintech Advisory',
    reading_time: '6 min read',
    status: 'PUBLISHED',
    is_ai_generated: 1,
    ai_seo_score: 97,
    seo_title: 'AI Deepfake Fraud & Scam Defense Protocols | Rahnoxa',
    seo_description: 'How businesses and fintech platforms can detect synthetic voice deepfakes, phishing scams, and protect transactions.',
    canonical_url: 'https://rahnoxa.rahnoxa-tech.workers.dev/blog/ai-deepfake-fraud-social-engineering-scams-detection-defense',
    published_at: new Date(Date.now() - 86400000 * 3).toISOString(),
    created_at: new Date(Date.now() - 86400000 * 3).toISOString(),
    content: `## Executive Overview: The Weaponization of Generative AI in Financial Fraud
...
- [Start a Project with Our Engineering Architects](/get-started)`,
  },
  {
    id: 'post-autonomous-ai-agents-enterprise',
    title: 'The Rise of Autonomous AI Agents in Enterprise Software Engineering',
    slug: 'autonomous-ai-agents-enterprise-software-engineering',
    category: 'AI & Machine Learning',
    excerpt: 'How autonomous multi-agent frameworks, LLM function calling, and deterministic toolchains are transforming software development, business automation, and IT operations.',
    featured_image: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1200&auto=format&fit=crop&q=80',
    tags: ['AI Agents', 'Machine Learning', 'LLMs', 'Automation', 'Enterprise'],
    author: 'Rahnoxa AI Labs',
    reading_time: '6 min read',
    status: 'PUBLISHED',
    is_ai_generated: 1,
    ai_seo_score: 96,
    seo_title: 'Autonomous AI Agents in Enterprise Software Engineering | Rahnoxa',
    seo_description: 'Explore how multi-agent AI frameworks and autonomous systems automate workflows, code generation, and enterprise operations.',
    canonical_url: 'https://rahnoxa.rahnoxa-tech.workers.dev/blog/autonomous-ai-agents-enterprise-software-engineering',
    published_at: new Date(Date.now() - 86400000 * 4).toISOString(),
    created_at: new Date(Date.now() - 86400000 * 4).toISOString(),
    content: `## Executive Overview: Beyond Chatbots to Autonomous Agentic Workflows
...
- [Start a Project](/get-started)`,
  ...
  {
    id: 'post-architecting-scalable-erp',
    title: 'Architecting Scalable Custom ERP Systems: Modular Monolith vs Microservices',
    slug: 'architecting-scalable-custom-erp-systems',
    category: 'ERP & Enterprise',
    excerpt: 'A technical blueprint on designing custom ERP systems that scale gracefully across inventory, multi-branch billing, HRMS, and supply chain workflows.',
    featured_image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&auto=format&fit=crop&q=80',
    tags: ['ERP', 'Modular Monolith', 'PostgreSQL', 'Architecture', 'Enterprise'],
    author: 'Rahnoxa Enterprise Architects',
    reading_time: '8 min read',
    status: 'PUBLISHED',
    is_ai_generated: 1,
    ai_seo_score: 99,
    seo_title: 'Architecting Scalable Custom ERP Systems | Rahnoxa',
    seo_description: 'Learn how to architect custom ERP systems with modular boundaries, real-time database sync, and enterprise RBAC.',
    canonical_url: 'https://rahnoxa.rahnoxa-tech.workers.dev/blog/architecting-scalable-custom-erp-systems',
    published_at: new Date(Date.now() - 86400000 * 5).toISOString(),
    created_at: new Date(Date.now() - 86400000 * 5).toISOString(),
    content: `## Executive Overview: Why Off-the-Shelf ERPs Fail Growing Enterprises
...
- [Book an Architectural Discovery Call](/get-started)`,
  },
  {
    id: 'post-real-time-saas-websockets',
    title: 'Building Real-Time SaaS Applications with WebSockets and Edge Infrastructure',
    slug: 'building-real-time-saas-applications',
    category: 'Software Architecture',
    excerpt: 'How to build sub-50ms real-time SaaS applications using WebSockets, edge workers, and Conflict-Free Replicated Data Types (CRDTs).',
    featured_image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1200&auto=format&fit=crop&q=80',
    tags: ['Real-Time', 'WebSockets', 'SaaS Architecture', 'Cloud', 'Performance'],
    author: 'Rahnoxa Systems Group',
    reading_time: '7 min read',
    status: 'PUBLISHED',
    is_ai_generated: 1,
    ai_seo_score: 95,
    seo_title: 'Building Real-Time SaaS Applications with WebSockets | Rahnoxa',
    seo_description: 'Architecting ultra-low latency real-time SaaS applications with WebSockets, edge computing, and CRDT synchronization.',
    canonical_url: 'https://rahnoxa.rahnoxa-tech.workers.dev/blog/building-real-time-saas-applications',
    published_at: new Date(Date.now() - 86400000 * 6).toISOString(),
    created_at: new Date(Date.now() - 86400000 * 6).toISOString(),
    content: `## Executive Overview: The Demand for Instant Collaborative Experiences
