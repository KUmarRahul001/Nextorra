...
const AdminChat: React.FC = () => {
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 text-center text-xs text-slate-500 space-y-4">
        ...
        <h3 className="text-base font-bold text-slate-900">Live Edge Visitor Telemetry</h3>
